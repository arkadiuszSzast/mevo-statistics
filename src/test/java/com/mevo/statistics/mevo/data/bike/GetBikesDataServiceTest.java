...
import static com.mevo.statistics.mevo.data.support.StringSupport.*;
import static org.assertj.core.api.Assertions.assertThat;
import static org.mockito.Matchers.any;
import static org.mockito.Mockito.when;

@ExtendWith(SpringExtension.class)
class GetBikesDataServiceTest {
    ...
    @InjectMocks
    private GetBikesDataService getBikesDataService;


    @Test
    void shouldReturnListOfBikes() throws IOException {
        //arrange
        var bikesFromLocationsAsStream = GetBikesDataServiceTest.class.getResourceAsStream(TEST_DATA_BIKES_FROM_LOCATIONS);
        ...
        //act
        var result = getBikesDataService.getData();
